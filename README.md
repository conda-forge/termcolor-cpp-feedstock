...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/termcolor-cpp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/termcolor-cpp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add termcolor-cpp
# for installing globally
pixi global install termcolor-cpp
```
...
It is possible to list all of the versions of `termcolor-cpp` available on your platform:
...
```
pixi search termcolor-cpp --channel conda-forge
```
